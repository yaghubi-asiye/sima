...
class FinancialGuaranteeController extends Controller
{
    ...
    public function index()
    {
        ...
        $guarantee3 = FinancialGuarantee::whereMonth('end_date',$days3->month)
        ->whereDay('end_date',$days3->day)
        ->get();


        $guarantee7 = FinancialGuarantee::whereMonth('end_date',$days7->month)
    ...
    {
        if (\Auth::user()->id == 6 OR \Auth::user()->id == 48 OR \Auth::user()->id == 23){
