...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'داشبورد مدیریتی شرکت ارتباطات پرشیا'); ?></title>
            ...
            <div class="col-md-4 col-10 box-shadow-2 p-0">
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  <div class="card-body">
                    <form class="form-horizontal form-simple" action="<?php echo e(route('login')); ?>" method="POST" >
                      <?php echo e(csrf_field()); ?>

                      <fieldset class="form-group position-relative has-icon-left mb-0">
                        <input type="text" class="form-control form-control-lg input-lg" name="email" value="<?php echo e(old('email')); ?>" id="email" placeholder="Email Address" autofocus required>
                    ...
                    <div class="form-group row">
                      ...
                      <div style="direction: rtl; " class="col-md-6 col-12 text-center text-md-left">
                        <fieldset style="float: right">
                          <input type="checkbox" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?> class="chk-remember">
