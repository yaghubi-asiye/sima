                                    ...
                                    <table style="font-family:Byekan;width: 100%" class="table display nowrap table-striped table-bordered scroll-horizontal file-export ">
                                        ...
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td style="white-space: normal"><?php echo e($item->day); ?></td>
                                                <td><?php echo e(jdate($item->date)); ?></td>
                                                <td style="white-space: normal"><?php echo e($item->start_time); ?></td>
                                                <td style="white-space: normal"><?php echo e($item->end_time); ?></td>
                                                <td style="white-space: normal"><?php echo e($item->end_time); ?></td>
                                            </tr>
