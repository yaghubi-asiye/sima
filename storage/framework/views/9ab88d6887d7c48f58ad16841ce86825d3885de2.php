            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div style="text-align: center!important;" class="modal-header">
                        <h4 style="text-align: center!important;" class="modal-title" id="ReferralsTdl<?php echo e($phoneBook->id); ?>">صورتجلسه</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div  style=" direction: rtl;" class="modal-body">
                        ...
                        <form style="vertical-align:center;text-align:center" method="post" action="/archive/update/<?php echo e($phoneBook->id); ?>"  enctype="multipart/form-data" class="form form-horizontal form-bordered striped-rows">
                            <?php echo csrf_field(); ?>
                            <div class="form-body">
                                ...
                                <div  class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="<?php echo e($phoneBook->number); ?>" class="form-control" name="number" >
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;vertical-align: center;font-size: 20px;color: #3BAFDA; " >
                                                    <?php if($archive->file == "storage/archive/nothing"): ?>
                                                        ---
                                                    <?php else: ?>
                                                        <a target="_blank" href="/<?php echo e($archive->file); ?>"> <?php echo $archive->file !== "storage/archive/nothing" ? "<i class='ft-file-text' ></i>" : ""; ?> </a>
                                                    <?php endif; ?>
                                                </td>
                                                ...
                                                <td style="text-align:center;color: #3BAFDA">
                                                    <a style="display:inline" data-toggle="modal" data-target="#ReferralsTdl<?php echo e($archive->id); ?>" ><i style="font-size: 20px" class="ft-external-link"></i></a>


                                                    <form style="display:inline" class="" action="<?php echo e(url('archive/delete', $archive->id)); ?>" method="post">
