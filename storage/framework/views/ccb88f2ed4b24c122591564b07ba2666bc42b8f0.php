                ...
                <table style="font-family:Byekan;width: 100%" class="table display nowrap table-striped table-bordered scroll-horizontal-exportTableButton file-export ">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="white-space: normal"><?php echo e($Certificate->saderKonandeh); ?></td>
                      <td><?php echo e($Certificate->dateStart); ?></td>
                      <td><?php echo e($Certificate->moddateEtebar); ?></td>
                      ...
                      <td style="text-align: center;vertical-align: center;font-size: 20px;color: #3BAFDA;" ><a target="_blank" href="<?php echo e($Certificate->file2); ?>"> <i class="ft-file-text" ></i> </a></td>

                      <td style="text-align:center;color: #3BAFDA">
                          <a href="Certificates/delete/<?php echo e($Certificate->id); ?> "><i style="font-size: 20px" class="ft-x-square danger"></i>  </a>
                          <a href="Certificates/edit/<?php echo e($Certificate->id); ?> ">
