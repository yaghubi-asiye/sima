...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'داشبورد مدیریت شرکت ارتباطات پرشیا'); ?></title>
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a style="color: #DCDCDC" class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="avatar avatar-online">
                                <img src="<?php echo e(\Auth::user()->avatar ? \Auth::user()->avatar : '/images/logo/logo-light-sm.jpg'); ?>"
                                        alt="avatar"><i></i>
                            </span><span
                                    class="user-name"  style="color: #DCDCDC"> <?php echo e(\Auth::user()->name . " " . \Auth::user()->family); ?> </span></a>
...
<div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content" style="background: #343a40;">
        <ul style="background: #343a40;" class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" <?php echo e((Request::is('timesheet') ? 'active' : '')); ?> nav-item">
            ...
            <li class=" <?php echo e((Request::is('dashboard') ? 'active' : '')); ?> nav-item">
            ...
            <li class=" <?php echo e((Request::is('Newtdl') ? 'active' : '')); ?> nav-item">
                <a class="orangeColor" href="/Newtdl"><i class="icofont icofont-dashboard-web"></i><span class="menu-title" data-i18n="nav.dash.main">فعالیت ها (جدید)  </span></a>
            </li>

            <li class="<?php echo e((Request::is('*invoices*') ? 'active' : '')); ?> <?php echo e((Request::is('*tenders*') ? 'active' : '')); ?>  nav-item has-sub">
            ...
            <li class="<?php echo e((Request::is('Inquiry') ? 'active' : '')); ?>  nav-item">
                <a class="orangeColor" href="/Inquiry"><i class="icon-basket"></i><span class="menu-title" data-i18n="nav.dash.main">  ثبت استعلامات  </span></a>

            </li>

            <li class="<?php echo e((Request::is('avl') ? 'active' : '')); ?>  nav-item">
            ...
            <li class="<?php echo e((Request::is('contracts') ? 'active' : '')); ?>  nav-item">
            ...
            <li class="<?php echo e((Request::is('SellersContracts') ? 'active' : '')); ?>  nav-item">
            ...
            <li class="<?php echo e((Request::is('*archives*') ? 'active' : '')); ?>   nav-item has-sub">
            ...
            <li style="" class="<?php echo e((Request::is('financialGuarantes') ? 'active' : '')); ?>  nav-item">
            ...
            <li style="" class="<?php echo e((Request::is('Approval') ? 'active' : '')); ?>  nav-item">
                <a class="orangeColor" href="/Approval"><i class="icon-magnet"></i><span class="menu-title" data-i18n="nav.dash.main">مصوبات</span></a>
            </li>

            

            <li class="<?php echo e((Request::is('Certificates') ? 'active' : '')); ?>  nav-item">
            ...
            <li class="<?php echo e((Request::is('Dokumentation') ? 'active' : '')); ?>  nav-item">
             ...
             <li class="<?php echo e((Request::is('regulations') ? 'active' : '')); ?>  nav-item">
            ...
            <li class="<?php echo e((Request::is('instructions') ? 'active' : '')); ?>  nav-item">
            ...
            <li class="<?php echo e((Request::is('phoneBooks') ? 'active' : '')); ?>  nav-item">
            ...
            <li style="" class="<?php echo e((Request::is('Baner') ? 'active' : '')); ?>  nav-item">
                <a class="orangeColor" href="/Baner"><i class="icon-docs"></i><span class="menu-title" data-i18n="nav.dash.main">  اطلاعیه ها</span></a>
            </li>
            ...
            <li style="" class="<?php echo e((Request::is('PerformanceEvaluation/create') ? 'active' : '')); ?>  nav-item">
                <a class="orangeColor" href="/PerformanceEvaluation/create"><i class="icon-wallet"></i><span class="menu-title" data-i18n="nav.dash.main">کارکرد ارزیابی عملکرد</span></a>
            </li>
            ...
            <li style="" class="<?php echo e((Request::is('chat') ? 'active' : '')); ?>  nav-item">
                <a class="orangeColor" href="/chat"><i class="icon-speech"></i><span class="menu-title" data-i18n="nav.dash.main">  چت</span></a>
            </li>

            <li style="" class="<?php echo e((Request::is('divar') ? 'active' : '')); ?>  nav-item">
                <a class="orangeColor" href="/divar"><i class="icon-notebook"></i><span class="menu-title" data-i18n="nav.dash.main">  دیوار</span></a>
            </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('administrator')): ?>
                <li class="<?php echo e((Request::is('users') ? 'active' : '')); ?>   nav-item has-sub">
...
<!-- END ROBUST JS-->
<!-- BEGIN PAGE LEVEL JS-->
<?php echo $__env->make('layouts.partials', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
