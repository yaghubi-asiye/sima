                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form style="vertical-align:center;text-align:center" enctype="multipart/form-data" method="post" action="<?php echo e(route('Approval.store')); ?>" class="form form-horizontal form-bordered striped-rows">
                                                        <?php echo csrf_field(); ?>
                                                        <div style="font-family:byekan" class="form-body productDivBody">
                                                            ...
                                                            <div class="form-group row" style="text-align:right;border:none">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input style="font-family:Byekan" class="form-control" value="<?php echo e(old('date')); ?>" autocomplete="off" placeholder="کلیک کنید" name="date" type="text" id="input1"/>
                                                                </div>

                                                                <label style="text-align: right" class="col-md-2 label-control" >شماره جلسه</label>
                                                                <div class="col-md-3">
                                                                    <input style="font-family:Byekan" class="form-control" value="<?php echo e(old('number')); ?>" name="number" type="text" />
                                                                </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input style="font-family:Byekan" class="form-control" value="<?php echo e(old('title')); ?>" name="title" type="text"/>
                                                                </div>
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input style="font-family:Byekan" class="form-control" value="<?php echo e(old('hazerin')); ?>" name="hazerin" type="text"/>
                                                                </div>
                                                                <div class="col-md-1"></div>
...
<script src="/js/scripts/pages/dashboard-project.js" type="text/javascript"></script>
    ...
    console.clear();
        ...
        $(document).ready(function () {
            let counter = 1;
            // let users = <?php echo json_encode($users->toArray()); ?>;
            // console.log(users);
