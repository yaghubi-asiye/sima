        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel17">پهنای باند </h4>
                    ...
                    <form style="vertical-align:center;text-align:center" enctype="multipart/form-data" method="post" action="<?php echo e(route('satellite.store')); ?>" class="form form-horizontal form-bordered striped-rows">
                        ...
                        <div style="font-family:byekan" class="form-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select id="sfloat_id" class="form-control"  name="sfloat_id">
                                        ...
                                        <?php $__currentLoopData = $floats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemvalue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($itemvalue->id); ?>"><?php echo e($itemvalue->name); ?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input style="font-family:Byekan" disabled class="form-control"  placeholder="کلیک کنید" name="date" type="text" id="input1"/>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-md-3 label-control" for="hour"> ساعت  </label>
                                <div class="col-md-9">
                                    ...
                                    <table style="font-family:Byekan;width: 100%" class="table display nowrap table-striped table-bordered scroll-horizontal file-export ">
                                        ...
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td style="white-space: normal"><?php echo e($item->sfloat_id); ?></td>
                                                <td style="white-space: normal"><?php echo e($item->date); ?></td>
                                                <td style="white-space: normal"><?php echo e($item->hour); ?></td>
                                                <td style="white-space: normal"><?php echo e($item->description); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                                    </table>
