        ...
        <form  style="vertical-align:center;text-align:center" method="post"  action="/Inquiry/add" enctype="multipart/form-data" class="form form-horizontal form-bordered striped-rows">
          ...
          <div class="form-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <input type="text" id="title" value="<?php echo e(old('title')); ?>"  class="form-control" name="title">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <input type="text" value="<?php echo e(old('namekarfarma')); ?>" id="namekarfarma" class="form-control" name="namekarfarma">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <input type="text" value="<?php echo e(old('nameproje')); ?>" id="nameproje" class="form-control" name="nameproje">
              </div>
            </div>
            ...
            <div class="form-group row">
              <label class="col-md-3 label-control" value="<?php echo e(old('file')); ?>" for="file">اسناد کارفرما </label>
              <div class="col-md-9">
                ...
                <div class="card-body card-dashboard">
                  <table style="font-family:Byekan;direction: rtl; width: 100%" class="table display  table-striped table-bordered scroll-horizontal file-export ">
                    ...
                    <tbody style="text-align: center" >
                      ...
                      <?php $__currentLoopData = $InquiryPersonal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $personnelTimesheet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        <td><?php echo e($personnelTimesheet->id); ?></td>
                        <td><?php echo e($personnelTimesheet->title); ?></td>
                        <td>
                        ...
                        <td><?php echo e($personnelTimesheet->nameproje); ?></td>
                        <td><?php echo e($personnelTimesheet->namekarfarma); ?></td>
                        <td><?php echo e($personnelTimesheet->nahveerja); ?></td>

                        <td><?php echo e(jdate($personnelTimesheet->created_at)); ?></td>
                        <td style="text-align: center;vertical-align: center;color: #3BAFDA; " >
                            <a target="_blank" href="/Inquiry/detail/<?php echo e($personnelTimesheet->id); ?>"> جزییات</a>
                        </td>
                      </tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card-content collapse show">
                    ...
                    <table style="font-family:Byekan;direction: rtl; width: 100%" class="table display nowrap table-striped table-bordered scroll-horizontal file-export ">
                        ...
                        <tbody style="text-align: center" >
                            ...
                            <?php $__currentLoopData = $InquiryAll; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $personnelTimesheet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($personnelTimesheet->id); ?></td>
                                <td><?php echo e($personnelTimesheet->title); ?></td>
                                <td>
