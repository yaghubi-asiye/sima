                                        ...
                                        <div class="modal-dialog modal-xl" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form style="vertical-align:center;text-align:center" enctype="multipart/form-data" method="post" action="<?php echo e(url('invoices')); ?>" class="form form-horizontal form-bordered striped-rows">
                                                        <?php echo csrf_field(); ?>
                                                        <div style="font-family:byekan" class="form-body productDivBody">
                                                            ...
                                                            <div class="form-group row" style="text-align:right">
                                                                ...
                                                                <label style="text-align: right" class="col-md-4 label-control" ><?php echo e(\Auth::user()->name . " " . \Auth::user()->family); ?> </label>
