                  ...
                  <?php $__currentLoopData = $contracts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e($loop->iteration); ?></td>
                        <td style="white-space: normal"><a href="<?php echo e(url('contracts/show/' . $contract->id)); ?>"><?php echo e($contract->onvan); ?></a></td>

                      <td style="white-space: normal"><?php echo e($contract->peymankar); ?></td>
                      ...
                      <td style="text-align:center;color: #3BAFDA">
                          ...
                          <a href="contracts/delete/<?php echo e($contract->id); ?> "><i style="font-size: 20px" class="ft-x-square danger"></i>  </a>
                          <a href="contracts/edit/<?php echo e($contract->id); ?> ">
