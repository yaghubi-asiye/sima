            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div style="text-align: center!important;" class="modal-header">
                        <h4 style="text-align: center!important;" class="modal-title" id="ReferralsTdl<?php echo e($phoneBook->id); ?>">آیین نامه</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div  style=" direction: rtl;" class="modal-body">
                        ...
                        <form style="vertical-align:center;text-align:center" method="post" action="regulation/update/<?php echo e($phoneBook->id); ?>"  enctype="multipart/form-data" class="form form-horizontal form-bordered striped-rows">
                            <?php echo csrf_field(); ?>
                            <div class="form-body">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;color: #3BAFDA">
                                                    ...
                                                    <a onclick="return confirm('آیا برای حذف اطمینان دارید؟');"
                                                       href="regulation/delete/<?php echo e($archive->id); ?> "><i
