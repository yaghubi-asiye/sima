...
@section('content')
    ...
    @foreach($archives as $phoneBook)
        <div style="font-family:Byekan" class="modal fade text-left" id="ReferralsTdl{{ $phoneBook->id }}" tabindex="-1"
             role="dialog" aria-labelledby="myModalLabel{{ $phoneBook->id }}" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div style="text-align: center!important;" class="modal-header">
                        <h4 style="text-align: center!important;" class="modal-title"
                            id="ReferralsTdl{{ $phoneBook->id }}">صورتجلسه</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div style=" direction: rtl;" class="modal-body">
                        ...
                        <form style="vertical-align:center;text-align:center" method="post"
                              action="/archive/update/{{ $phoneBook->id }}" enctype="multipart/form-data"
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="{{ $phoneBook->number }}" class="form-control"
                                               name="number">
                                    </div>
                                        ...
                                        @foreach($archives as $archive)
                                            <tr>
                                                ...
                                                <td style="text-align: center;vertical-align: center;font-size: 20px;color: #3BAFDA; ">
                                                    ...
                                                    @else
                                                        <a target="_blank"
                                                           href="/{{ $archive->file }}"> {!! $archive->file !== "storage/archive/nothing" ? "<i class='ft-file-text' ></i>" : "" !!} </a>
                                                    @endif
                                                </td>
