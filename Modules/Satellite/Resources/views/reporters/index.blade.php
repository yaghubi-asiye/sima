        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form style="vertical-align:center;text-align:center" enctype="multipart/form-data" method="post" action="{{route('satellite.store')}}" class="form form-horizontal form-bordered striped-rows">
                        @csrf
                                    ...
                                    <table style="font-family:Byekan;width: 100%" class="table display nowrap table-striped table-bordered scroll-horizontal file-export ">
                                        ...
                                        @foreach($data as $item)
                                            <tr>
                                                ...
                                                <td style="white-space: normal">{{ $item->hour }}</td>
